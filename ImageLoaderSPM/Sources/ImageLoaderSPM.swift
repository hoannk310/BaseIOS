...
nonisolated(unsafe) private let imageCache = NSCache<NSURL, UIImage>()

public extension UIImageView {
    private struct AssociatedKeys {
        nonisolated(unsafe) static var currentURLKey: UInt8 = 0
        nonisolated(unsafe) static var loadingIndicatorKey: UInt8 = 1
    }
    ...
    func loadImageBySPM(from url: URL,
